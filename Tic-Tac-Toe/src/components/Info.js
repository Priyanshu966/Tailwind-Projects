...
const Info = () => {
  return (
    <div className="flex items-center space-x-5 mb-2">
      ...
      <div className="w-8 h-8 bg-slate-400 hover:bg-slate-300 hover:-translate-y-px text-slate-950 rounded-md grid place-items-center border-b-slate-500 border-b-4 ">
